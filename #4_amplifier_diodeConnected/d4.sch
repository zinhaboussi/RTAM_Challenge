...
N 590 -370 710 -370 {
lab=out}
N 590 -410 590 -370 {lab=out}
N 540 -440 550 -440 {lab=out}
N 540 -440 540 -400 {lab=out}
N 540 -400 590 -400 {lab=out}
N 590 -440 610 -440 {lab=VDD}
N 610 -470 610 -440 {lab=VDD}
N 590 -470 610 -470 {lab=VDD}
...
C {devices/vdd.sym} 590 -470 0 0 {name=l3 lab=VDD}
C {devices/gnd.sym} 590 -310 0 0 {name=l4 lab=GND}
C {devices/vsource.sym} 510 -260 0 0 {name=V2 value="0.63 AC 1"}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 570 -440 0 0 {name=M2
W=216
L=0.35
nf=1
mult=1
