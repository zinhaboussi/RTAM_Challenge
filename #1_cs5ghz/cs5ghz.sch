...
N 590 -370 710 -370 {
lab=out}
C {devices/title.sym} 190 -60 0 0 {name=l1 author="Zineddine Haboussi"}
C {sky130_fd_pr/nfet_01v8.sym} 570 -340 0 0 {name=M2
L=0.15
W=86.12
nf=1 mult=1
model=nfet_01v8
...
C {devices/vsource.sym} 510 -260 0 0 {name=V2 value="1 AC 1"}
